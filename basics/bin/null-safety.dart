...
final lengthForSure = myLastname!.length;//assuming it is not null

// Safe calls
var length = myLastname?.length;//if it's null, it's not going to execute length
// is not using very often in flutter
